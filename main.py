...
parser.add_argument('--dataset', type=str, default='ml_20m_visit', choices=['ml_20m_visit', 'steam_visit', 'Toys_visit', 'Yelp_visit', 'ml_1m_visit', 'yoochoose_visit', 'merge_visit', 'Beauty_visit', 'Sports_visit'],help='dataset for training')
